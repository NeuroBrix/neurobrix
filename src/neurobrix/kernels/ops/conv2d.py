...
@nbx_autotune(
    ...
    key=['batch_bucket', 'in_feat_dim', 'in_height_bucket', 'in_width_bucket',
         'out_feat_dim', 'out_height_bucket', 'out_width_bucket',
...
def conv2d_forward_kernel(
    ...
    batch_bucket, in_height_bucket, in_width_bucket, out_height_bucket, out_width_bucket,
