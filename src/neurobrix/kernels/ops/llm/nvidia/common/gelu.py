...
@register_kernel(family="llm", vendor="nvidia", tier="common", op_name="gelu")
def gelu_kernel(x: torch.Tensor, approximate: str = "tanh") -> torch.Tensor:
    ...
    Returns:
        Result tensor
    """
    # Note: This kernel always uses the tanh approximation
    # The approximate parameter is accepted for API compatibility but ignored
