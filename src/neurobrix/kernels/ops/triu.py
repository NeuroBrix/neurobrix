"""Upper triangular — pure @triton.jit kernels. Extracted from FlagGems.

triu_kernel: 2D version, iterates over N blocks per row.
triu_batch_kernel: batched version, handles N-D tensors flattened to (batch, M*N).
"""
