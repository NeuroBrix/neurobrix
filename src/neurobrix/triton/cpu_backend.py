...
def ensure_triton_cpu_or_raise() -> None:
    ...
    raise TritonCPUNotInstalledError(
        ...
        "\n"
        "See docs/triton_cpu_install.md for verified versions, supported "
        "platforms (x86_64 Linux / arm64 macOS), and build-from-source "
        "instructions for distros without prebuilt wheels.\n"
        "\n"
