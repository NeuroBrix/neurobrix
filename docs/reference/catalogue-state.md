...
| `genmo/Mochi-1-preview` | video | 38.2 | FAILED rc=-9 — killed at 2700 s | 0† | 0† | not measured | 0 shapes met | transformer `seq_len`@256 (weight-extent); transformer `seq_len`@256 (weight-extent) | `D-MOCHI-CUDA-700-AT-MM` | measured |
